...
function loadtranscribe(fileName) {
  ...
  xhr.onload = function () {
    if (this.status == 200) {
      ...
      document.getElementById("ttsTranscribe").onclick = function () {
        tts(transcribeText)
      };

      // document.getElementById("qatranscribe").onclick = function () {
      //   queans(transcribeText)
      // };
...
function loadsummary(transcribeTxt) {
  ...
  xhr.onload = function () {
    ...
    if (this.status == 200) {
      ...
      // document.getElementById("qasummary").onclick = function () {
      //   queans(summaryText)
      // };
...
// function queans(text) {
//   let xhr = new XMLHttpRequest();

//   console.log('inside queans')
//   xhr.open("POST", "/qa", true);
//   //Send the proper header information along with the request
//   xhr.setRequestHeader("Content-Type", "application/json");

//   xhr.onload = function () {
//     console.log('inside queansload')
//     if (this.status == 200) {
//       console.log(this.responseText)
//     }
//     else {
//       console.log("inside queans else")
//     }
//   }
//   params = { "data": text }
//   console.log(params)
